                ...
                <Card>
                    ...
                    <CardBody className="overflow-x-scroll px-0 pt-0 pb-2 ">
                        <div className="flex justify-end mb-4 mr-4">
                                <Button className="bg-[#60a563]" ripple="light" onClick={handleAddPurchase}>
                                    Add Purchase
                                </Button>
                    </div>
                        <table className="w-full min-w-[640px] table-auto">
                            <thead>
                                <tr>
                                    {["Date","Cash/credit","Product Name","Product category","Units Purchased","Unit Cost","Invoice Cost","VAT applicable","VAT","Other Taxes","Total Cost",""].map((el) => (
                                        <th key={el}
